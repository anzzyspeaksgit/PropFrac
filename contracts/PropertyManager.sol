 ...
 */
contract PropertyManager is ReentrancyGuard, Ownable, Pausable {
        ...
        whenNotPaused
    {
        ...
        listings[propertyId] = Listing({
            propertyId: propertyId, fractionsAvailable: fractions, pricePerFraction: pricePerFraction, active: true
        });
